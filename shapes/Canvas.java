...
public class Canvas{
    ...
    public void setForegroundColor(String colorString){
        if(colorString.equals("red"))
            ...
            graphic.setColor(new Color(190, 100, 30));            
        ...
        else if(colorString.equals("chartreuse"))
            graphic.setColor(new Color(127, 255, 0));
        else if(colorString.equals("peru"))
            graphic.setColor(new Color(205, 133, 63));
        else if(colorString.equals("slateGray"))
        ...
        else if(colorString.equals("rosyBrown"))
